...
NAMESPACE="default"
KUBECFG_FILE_NAME="./admin-kubeconfig"
TARGET_FOLDER="/tmp/"
...
create_service_account() {
  ...
  kubectl create clusterrolebinding clusterrolebinding-"${SERVICE_ACCOUNT_NAME}" \
    --clusterrole=cluster-admin \
    --serviceaccount=default:"${SERVICE_ACCOUNT_NAME}" --namespace "${NAMESPACE}"
}
